...
namespace Horlyk\Test {
    ...
    class QueryBuilderTest extends AbstractQueryBuilderTest
    {
        ...
        public function testQueryVarDump()
        {
            $queryBuilder = $this->getQueryBuilder();

            $expected = '/home/horlyk/www/packages/horlyk/fetch-xml-bundle/src/Services/QueryBuilder.php:117:
string(61) "<fetch><entity name="user"><all-attributes/></entity></fetch>"
';
            $this->expectOutputString($expected);

            $queryBuilder->getQuery(true);
        }

        public function testQueryDump()
        {
            $queryBuilder = $this->getQueryBuilder();

            defineDumpFunction();

            $expected = '/home/horlyk/www/packages/horlyk/fetch-xml-bundle/tests/QueryBuilderTest.php:7:
string(61) "<fetch><entity name="user"><all-attributes/></entity></fetch>"
';
